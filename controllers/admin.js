...
exports.getAddProduct = (req,res,next)=>{
    ...
    res.render("admin/edit-product", {pageTitle :"Add Product", editing: false, path: "admin/edit-product"})
}
...
exports.getProducts = (req, res, next) => {
    ...
    {prods : products,
     pageTitle: 'All Products', path: "admin/products"})});
}
